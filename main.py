...
def ShowStartInterface(screen, screensize):
    ...
    tfont = pygame.font.Font(FONTPATH, screensize[0] // 5)
    cfont = pygame.font.Font(FONTPATH, screensize[0] // 20)
    title = tfont.render("Skier Game", True, (255, 0, 0))
    content = cfont.render("Press any key to START.", True, (0, 0, 255))
...
def main():
    ...
    while True:
        ...
        if hitted_obstacles:
            if (
                hitted_obstacles[0].attribute == "tree"
                and not hitted_obstacles[0].passed
            ):
                score -= 50
                skier.setFall()
                ...
                hitted_obstacles[0].attribute == "flag"
                and not hitted_obstacles[0].passed
            ):
                score += 10
